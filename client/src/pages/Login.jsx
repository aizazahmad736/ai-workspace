  ...
  return (
    <div>
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          <div className="flex justify-between items-center mb-1.5">
            ...
            <Link to="/forgot-password" className="text-[10px] text-violet-400 hover:underline">Forgot password?</Link>
          </div>
          <div className="relative">
      ...
      <p className="text-xs text-gray-400 text-center mt-6">
        ...
        <Link to="/register" className="text-violet-400 hover:underline font-medium">Create one</Link>
      </p>
    </div>
  );
};
